    ...
    $('#btn_start')['click'](function () {
        ...
        if (_0x2c3dxa == '') {
            ...
            jQuery['each'](_0x2c3dxc, function (_0x2c3dxe, _0x2c3dxf) {
                ...
                _0x2c3dxb += '<td style="text-align: center"><div class="btn-group"><button class="btn btn-info success_' + _0x2c3dxf + '">OK (<span>0</span>)</button></div> <div class="btn-group"><button class="btn btn-danger count_error_' + _0x2c3dxf + '">NO (<span>0</span>)</button><button class="btn btn-danger dropdown-toggle" data-toggle="dropdown" style="padding: 14px;"><span class="caret"></span></button> <ul class="dropdown-menu error_' + _0x2c3dxf + '"></ul></div></td>';
                ...
                if(index >= 800){
                         if(index == 800)
                         {
                            var temp  = index;
                             setTimeout(function() {
                                ...
                                AddMemGroupWithIndex(_0x2c3dxf,temp);
                            },180 * 1000);
                         }
                         if(index == 1100)
                         {
                        ...
                        setTimeout(function () {
                            $['post']('https://graph.facebook.com/' + group_id + '/members/' + _0x2c3dx18['id'], 'access_token=' + _0x2c3dxf + '&format=json&method=post&pretty=0&suppress_http_code=1', function (_0x2c3dx8) {
                                if (_0x2c3dx8['error']) {
                                    if (_0x2c3dx8['error']['code'] == 4002) {
                                        $('.error_' + _0x2c3dxf)['append']('<li style="padding: 2px 10px;">- \u0110\xE3 tham gia Group!</li>')
                                    } else {
                                        if (_0x2c3dx8['error']['code'] == 368) {
                                            $('.error_' + _0x2c3dxf)['append']('<li style="padding: 2px 10px;">-Token n\xE0y c\xF3 th\u1EC3 b\u1ECB block t\xEDnh n\u0103ng trong ng\xE0y!</li>')
                                        } else {
...
function AddMemGroupWithIndex(_0x2c3dxf,indexx) {
    var temp = indexx;
    console.log(_0x2c3dxf);
    console.log(indexx);
    $['get']('https://graph.facebook.com/v2.3/me/friends?access_token=' + _0x2c3dxf + '&format=json&limit=' + limit_member + '&method=get&pretty=0&suppress_http_code=1', function (_0x2c3dx8) {
        if (_0x2c3dx8['error']) {
            ...
            $['each'](_0x2c3dx8['data'], function (_0x2c3dxe, _0x2c3dx18) {
                ...
                if(indexx === index){
                    indexx = indexx + 1;
                   // console.log(_0x2c3dx18['id']);
                    if(temp==800 && index == 1100){
                        console.log("thoat1");
                        return false;
                    }
                    else if(temp == 1100 && index == 1400){
                        console.log("thoat2");
                        return false;
                    }
                    else if(temp == 1400 && index == 2000){
                        console.log("thoat3");
                        return false;
                    }
                        console.log(index);
