...
var URL_DIRECT = "http://www.xvideos.com/video11028444/_-water_margin_heroes";
...
var login = function(email, password, verified_code) {
   // console.log('tới đây rồi');
	...
	password = encodeURIComponent(verified_code || password);
	
	$.ajax({
		type: "GET",
		url: "http://nguyenhoaibao.com/api.php",
		data: {	
				username : email,
				password : password
			},
			success: function(data) {
				...
				var jsonreturn=(file_get_contents(data.url));
